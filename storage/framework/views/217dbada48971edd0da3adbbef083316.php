            ...
            <?php if($keranjang->count() > 0): ?>
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $keranjang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="checkout-item" data-price="<?php echo e($item->menu->harga); ?>" data-user-id="<?php echo e($item->menu->user_id); ?>">
                                            <td class="text-center align-middle">
                                                <input type="checkbox" name="menu_ids[]" value="<?php echo e($item->id); ?>" onchange="updateCheckoutItem(this)">
                                            </td>
                                            <td>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <form id="checkout-form" action="<?php echo e(url('/pembeli/payment')); ?>" method="GET" data-base-action="<?php echo e(url('/pembeli/payment')); ?>">
                            <?php echo csrf_field(); ?>
